...
export default class Calculator {
    constructor() {
        this.acceptDot = true;
        this.digitStack1 = new DigitStack();
        this.digitStack2 = new DigitStack();
        this.digitStack3 = new DigitStack();
        this.result = "";
        this.display = "";
        this.getInput = getFirstNumberInput;
    }
    /**
     ...
     * @param {'del', '.', '/', '*', '-', num} input calculator operation
     */
    getPrioritySecondNumberInput = (input) => {
        if (!getInputHelper(input, digitStack2) && (digitStack2.size > 1)) {
